    ...
    <>
      ...
      <div className="docs-layout">
        ...
        <article className="docs-article">
          ...
          <section id="answers"><span><ShieldCheck size={17} /></span><h2>Grounded answers</h2><p>Hybrid retrieval fuses pgvector similarity with PostgreSQL full-text ranking. Pinned answers win first. Weak matches return the configured fallback. Ollama is optional.</p></section>
          <section id="production"><span><Code2 size={17} /></span><h2>Production checklist</h2><ul><li><CheckCircle2 size={13} /> Replace development auth with Clerk or your own adapter</li><li><CheckCircle2 size={13} /> Put PostgreSQL on durable encrypted storage</li><li><CheckCircle2 size={13} /> Run at least one independent worker process</li><li><CheckCircle2 size={13} /> Add Sentry DSN and centralized log transport</li><li><CheckCircle2 size={13} /> Restrict widget domains and configure a reverse proxy</li></ul><Link href="/dashboard/integrations">Review integrations <ExternalLink size={12} /></Link></section>
        </article>
      </div>
    </>
  );
